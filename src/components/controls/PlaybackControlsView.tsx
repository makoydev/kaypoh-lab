...
interface PlaybackControlsViewProps {
  playing: boolean
  speed: SpeedMultiplier
  onToggle: () => void
  onSpeed: (speed: SpeedMultiplier) => void
  layoutId?: string
}

/** Play / pause plus the three speed multipliers. Module-agnostic. */
export function PlaybackControlsView({ playing, speed, onToggle, onSpeed, layoutId = 'speed' }: PlaybackControlsViewProps) {
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="min-w-0 flex-1">
        ...
        <SegmentedControl layoutId={layoutId} options={SPEEDS} value={speed} onChange={onSpeed} />
      </div>
    </div>
  )
}
